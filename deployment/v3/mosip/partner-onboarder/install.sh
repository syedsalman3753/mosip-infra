...
function installing_onboarder() {
  ...
  if [ $yn = "Y" ]; then
    ...
    helm -n $NS install partner-onboarder nira/partner-onboarder  --set-string nodeSelector.vlan="200" \
...
GITHUB_URL="https://github.com/niragit/mosip-infra/blob"
FILE_PATH="/deployment/v3/niragit/partner-onboarder/README.md"
